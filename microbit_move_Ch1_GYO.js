...
input.onButtonPressed(Button.A, () => {
    Pixel.setPixelColor(0, neopixel.colors(NeoPixelColors.Green))
    Pixel.setPixelColor(1, neopixel.colors(NeoPixelColors.Yellow))
    Pixel.setPixelColor(2, neopixel.colors(NeoPixelColors.Green))
    Pixel.setPixelColor(3, neopixel.colors(NeoPixelColors.Yellow))
    Pixel.setPixelColor(4, neopixel.colors(NeoPixelColors.Orange))
})
